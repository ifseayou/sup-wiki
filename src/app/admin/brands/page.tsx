...
function BrandForm({ data, onChange }: { data: Record<string, unknown>; onChange: (d: Record<string, unknown>) => void }) {
  ...
  return (
    <div className="space-y-4">
      ...
      <div>
        <label className="block text-xs text-warm-gray-400 mb-1">Logo URL</label>
        <input className={inp} value={String(data.logo || '')} onChange={e => set('logo', e.target.value)} placeholder="https://..." />
      </div>
      <div>

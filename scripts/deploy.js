...
const archiveDeployCommand = [
  ...
  `rsync -a --delete --exclude .env.local --exclude .cache --exclude node_modules --exclude .next --exclude public/result-books ${shellQuote(`${remoteReleaseDir}/`)} ${shellQuote(`${config.deployPath}/`)}`,

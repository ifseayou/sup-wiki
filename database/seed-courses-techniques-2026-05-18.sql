...
INSERT INTO sup_courses (slug, title, subtitle, summary, description, venue, schedule_note, equipment_note, board_note, duration_minutes, price_display, price_options, sort_order, status) VALUES
('sup-experience','桨板体验','零基础轻松下水','提供划水器材，人来即可。重在体验，穿好救生衣之后，在指定区域内划水即可。','适合第一次接触桨板的朋友，用最轻松的方式完成安全穿戴、上下板、指定区域内划水体验。','中流击水桨板俱乐部（余杭塘河-梦想小镇段）','课程时间和教练自行约定','提供划水器材，人来即可','充气休闲板',60,'128元/1小时/人；218元/2小时/人',JSON_ARRAY(JSON_OBJECT('label','1小时体验','price',128,'duration','1小时/人'),JSON_OBJECT('label','2小时体验','price',218,'duration','2小时/人')),1,'published'),
('sup-beginner','桨板入门课','从安全到独立划行','从桨板技术动作库中选择基础动作教学，建立上下水、站立、直线划行、转向、停止和回板能力。','面向希望真正学会桨板的零基础学员，课程重点是安全基础、身体姿态、划行发力和落水回板。','中流击水桨板俱乐部（余杭塘河-梦想小镇段）','课程时间和教练自行约定','提供基础教学器材','教学板',180,'598元/3小时/人',JSON_ARRAY(JSON_OBJECT('label','入门课','price',598,'duration','3小时/人')),2,'published'),
('sup-advanced','桨板进阶课','竞速板技术强化','使用竞速板，从技术动作库中选择非入门课的进阶动作，强化支撑、走板、控板、转向和救援能力。','适合已有基础、希望提升控板能力和复杂场景处理能力的学员。','中流击水桨板俱乐部（余杭塘河-梦想小镇段）','课程时间和教练自行约定','提供进阶训练所需器材','竞速板',180,'980元/3小时/1人',JSON_ARRAY(JSON_OBJECT('label','进阶课','price',980,'duration','3小时/1人')),3,'published'),
('sup-combo','入门&进阶','完整技术路径','覆盖入门和进阶技术动作，从安全基础一路练到支撑、走板、高阶转向与救援。','适合希望一次性建立完整桨板技术路径的学员，包含入门动作和进阶动作。','中流击水桨板俱乐部（余杭塘河-梦想小镇段）','课程时间和教练自行约定','提供完整训练器材','教学板 + 竞速板',360,'1580元/6小时/人',JSON_ARRAY(JSON_OBJECT('label','入门&进阶','price',1580,'duration','6小时/人')),4,'published')
ON DUPLICATE KEY UPDATE
